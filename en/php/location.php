    ...
    <div class="container">
        ...
        <div class="row card-1 white-bg">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <h3 class="text-center">Windsurf Center <span> Premantura </span> </h3>
                <P>The Center, which started as a windsurfing school and bicycle rental spot, has not stopped developing
                    since its beginning. Over the years, we have developed into a windsurfing center which is well
                    stocked with both school and rental boards. </P>
