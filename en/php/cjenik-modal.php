    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title text-center lead">PRICE LIST </h3>
            </div>
            <div class="modal-body">
                <h4 class="text-center">EXCURSIONS</h4>
                ...
                <h4 class="text-center">KAYAK RENTAL</h4>
                <div class="table-responsive">
                    <table class="table table-hover table-striped">
                        <thead>
                            <tr>
                                <th scope="col">KAYAK 1</th>
                                <th scope="col">1 PAX </th>
                                <th scope="col">KAYAK 2</th>
                                <th scope="col">2 PAX </th>
                                <th scope="col">KAYAK 3</th>
