    ...
    <div class="container">
        ...
        <div class="row card-1 white-bg">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <p>Il Windsurfing Center Premantura nasce nel 2000. Fondato come scuola di windsurf e punto di noleggio
                    biciclette, il Centro non ha smesso di crescere sin dal suo inizio. Nel corso degli anni ci siamo
                    trasformati in un centro di windsurf ben fornito di tavole scolastiche e di noleggio.
                </p>
                ...
                <div class="row card-1 white-bg" data-mh="my-other-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 l-img-holder ">
                        <a href="https://www.rentabikepremantura.com/" target="_blank">
                            <img class=" img-responsive" src="../img/centar-bike-m.jpg"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 pb-10">
                        ...
                        <hr>
                        <p> Il modo migliore per vivere a contatto con la natura di Kamenjak è visitarlo facendo un giro
                            con il mountain bike. Offriamo le bici in noleggio con o senza guida. Disponiamo di due
                            punti di noleggio: a Premantura, sulla strada che porta verso il Campeggio ArenaStupice, al
                            numero civico 63 di fronte al Surf Bar e nel CampeggioArenaStupice. Disponiamo di una vasta
                            scelta di bici di diverse dimensioni e qualità.
                        </p>
                        <hr>
                        <div class="text-left l-link">
            ...
            <div class=" col-sm-6  drugi-location">
                <div class="row card-1 white-bg " data-mh="my-other-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12  l-img-holder ">
                        ...
                        <a href="#">
                            <img class=" img-responsive" src="../img/centri/medulin-small.jpg"
                                alt="Windsurf Centar Medulin">
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 pb-10">
                        ...
                        <hr>
                        <p>Il nostro centro a Medulin si trova nel Campeggio ArenaMedulindove è possibile prenotare
                            piazzole o mobile home. Essendo una località turistica, Medulin offre tutti i tipi di
                            alloggio, dagli alberghi ai camping. </p>
                        <div class="l-iconi-wrapper clearfix">
                            ...
                            <div> <span class="l-iconi text-center"><img class="img-responsive"
                                        src="../img/iconi/sup.png" alt="surf-icon"> </span> </div>
                        </div>
                        <hr>
                        <div class="text-left l-link">
                            <a href="https://www.windsurfing.hr/" target="_blank"> www.windsurfing.hr </a>
